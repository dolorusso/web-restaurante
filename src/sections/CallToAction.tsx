  ...
  return (
    <section className="bg-gradient-to-b from-white  to-orange-100 py-24">
      <div className="container max-w">
        <h2 className="text-center text-3xl md:text-[54px] md:leading-[60px] font-bold tracking-tighter bg-gradient-to-b from-orange-600 to-[#961903] text-transparent bg-clip-text">Veni a conocernos</h2>
